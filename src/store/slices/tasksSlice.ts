...
export const defaultInitialTasks: Task[] = [
  {
    ...
    subtasks: [
      { id: generateUUID(), taskId: 'demo-task-1', title: '10 mins box breathing exercise', isCompleted: true, position: 0, createdAt: new Date().toISOString() },
      { id: generateUUID(), taskId: 'demo-task-1', title: 'Drink warm lemon water', isCompleted: true, position: 1, createdAt: new Date().toISOString() },
      { id: generateUUID(), taskId: 'demo-task-1', title: 'Write 3 gratitude notes in journal', isCompleted: false, position: 2, createdAt: new Date().toISOString() },
    ],
  },
  {
    id: generateUUID(),
    ...
    updatedAt: new Date().toISOString(),
    subtasks: [
      { id: generateUUID(), taskId: 'demo-task-2', title: 'Test 2-dropdown filter selectors', isCompleted: true, position: 0, createdAt: new Date().toISOString() },
      { id: generateUUID(), taskId: 'demo-task-2', title: 'Check dark mode color contrast', isCompleted: false, position: 1, createdAt: new Date().toISOString() },
    ],
  },
];
...
export const tasksSlice = createSlice({
  ...
  reducers: {
    ...
    addTask: (state, action: PayloadAction<Omit<Task, 'id' | 'createdAt' | 'updatedAt' | 'position'> & { id?: string }>) => {
    ...
    addSubtask: (state, action: PayloadAction<{ taskId: string; title: string; id?: string }>) => {
